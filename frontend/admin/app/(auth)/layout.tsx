        ...
        <div className="mx-auto w-full max-w-sm">
          <div className="mb-8 flex items-center justify-between gap-2.5">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-xl font-semibold">PayCam Admin</span>
            </div>
      ...
      <div className="relative hidden w-1/2 flex-col justify-between bg-primary p-12 text-primary-foreground lg:flex">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <h2 className="text-3xl font-semibold leading-tight">{t("auth.brandHeadline")}</h2>
            <p className="text-primary-foreground/80">{t("auth.brandBody")}</p>
          </div>
        </div>
