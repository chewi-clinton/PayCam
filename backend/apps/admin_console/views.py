...
@extend_schema(tags=["Admin"], summary="Platform-wide stats across all merchants")
class PlatformStatsView(generics.GenericAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        merchant_counts = User.objects.filter(role="merchant").aggregate(
            total=Count("id"),
        ...
        return Response(
            {
                "merchant_count": merchant_counts["total"] or 0,
                "suspended_merchant_count": merchant_counts["suspended"] or 0,
